...
func main() {
	...
	// string flag word with a default value "foo" and a short description.
...
// Omitted flags take up defaults
...
// before positional arguments (otherwise the flags will be interpreted as positional arguments).
