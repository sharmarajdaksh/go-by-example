...
// decoding, including to and from built-in and custom data types.
...
func main() {
	...
	// When decoding JSON data need to provide a variable where
	// the JSON package can put the decoded data. This map[string]interface{}
	// will hold a map of strings to arbitrary data types.
	var dat map[string]interface{}

	// Decoding with a check for associated errors.
	...
	// For example here we convert the value in num to the
	...
	res := response2{}
	// Unmarshal JSON in byte array form of str and
	// store unmarshalled data to res
