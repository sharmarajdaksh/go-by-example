...
// Len and Swap will usually be similar across types and Less will hold the
// actual custom sorting logic. In our case we want to sort in order of
...
func main() {
	// We can now implement our custom sort by converting the original
